    ...
    public static class InitData
    {
        public static void Init()
        {
            using (var db = new VietTravel.VietTravelDBContext())
            {
                ...
                db.PROVINCEs.Add(new PROVINCE() { provinceName = "Ha Noi", latitude = 21.028919f, longtitude = 105.854622f, totalArea = 1285, populationProvince = 7588, regionID = 1 });
                ...
                db.LOCATIONS.Add(new LOCATION() { locationID = 1, typeID = 1, locationName = "Starlight Bridge", locationAddress = "Phu My Hung, District 7, Ho Chi Minh City", provinceID = 10 });
                db.LOCATIONS.Add(new LOCATION() { locationID = 2, typeID = 1, locationName = "Bitexco financial tower", locationAddress = "02 Hai Trieu Street, Ben Nghe Ward, District 1, Ho Chi Minh City", phoneNumber = "+84 8 39156868", website = "http://www.bitexcofinancialtower.com/", longitude = 106.704545f, latitude = 10.771845f, provinceID = 10 });
                db.LOCATIONS.Add(new LOCATION() { locationID = 3, typeID = 1, locationName = "Turtle Lake", locationAddress = "Ward 6, District 3, Ho Chi Minh City", longitude = 106.695833f, latitude = 10.782500f, provinceID = 10 });
                db.LOCATIONS.Add(new LOCATION() { locationID = 4, typeID = 1, locationName = "Nguyen Hue Walking Street", locationAddress = "Nguyen Hue Street, Ben Nghe Ward, District 1, Ho Chi Minh City", provinceID = 10 });
                db.LOCATIONS.Add(new LOCATION() { locationID = 5, typeID = 1, locationName = "Dam Sen Park", locationAddress = "03 Hoa Binh Street, Ward 3, District 11, Ho Chi Minh City", phoneNumber = "+84 8 3963 3593", priceMin = 100000, priceMax = 300000, website = "http://damsenpark.com.vn", provinceID = 10 });
                db.LOCATIONS.Add(new LOCATION() { locationID = 6, typeID = 1, locationName = "Independence Palace", locationAddress = "135 Nam Ky Khoi Nghia, District 1, Ho Chi Minh City", phoneNumber = "+84 8 3822 3652", priceMin = 20000, priceMax = 40000, website = "https://www.dinhdoclap.gov.vn", provinceID = 10 });
                db.LOCATIONS.Add(new LOCATION() { locationID = 7, typeID = 1, locationName = "Ben Thanh Market", locationAddress = "Le Loi Street, Ben Thanh Ward, District 1, Ho Chi Minh City", website = "http://chobenthanh.org.vn", longitude = 106.698006f, latitude = 10.772449f, provinceID = 10 });
                db.LOCATIONS.Add(new LOCATION() { locationID = 8, typeID = 2, locationName = "Pancakes Dinh Cong Trang", locationAddress = "46 Dinh Cong Trang Street, Tan Dinh Ward, District 1, Ho CHi Minh City", phoneNumber = "08 3824 1110", provinceID = 10 });
                db.LOCATIONS.Add(new LOCATION() { locationID = 9, typeID = 2, locationName = "Love Eat", locationAddress = "29 Hai Trieu, Ben Nghe Ward, District 1, Ho Chi Minh City", phoneNumber = "+84 8 6260 2727", website = "http://loveat.com.vn", provinceID = 10 });
                db.LOCATIONS.Add(new LOCATION() { locationID = 10, typeID = 2, locationName = "Hang Duong Restaurant", locationAddress = "224 No.48 Street, Ward 5, District 4, Ho Chi Minh City", phoneNumber = "+84 8 3826 4439", website = "http://Hangduongquan.vn", provinceID = 10 });
                db.LOCATIONS.Add(new LOCATION() { locationID = 11, typeID = 2, locationName = "Sai Gon Grill", locationAddress = "91 Pasteur Street, Ben Nghe Ward, District 1, Ho Chi Minh City", phoneNumber = "+84 91 662 26 62", website = "http://Saigongrill.vn", provinceID = 10 });
                db.LOCATIONS.Add(new LOCATION() { locationID = 12, typeID = 2, locationName = "Pendolasco", locationAddress = "87 Nguyen Hue Street, Ben Nghe Ward, District 1, Ho Chi Minh City", phoneNumber = "+84 8 3821 8181", website = "http://pendolasco.vn", provinceID = 10 });
                db.LOCATIONS.Add(new LOCATION() { locationID = 13, typeID = 2, locationName = "Rom BBQ Restaurant", locationAddress = "2 Luu Van Lang Street, Ben Thanh Ward, District 1, Ho Chi Minh City", phoneNumber = "+84 8 3822 0060", website = "http://rombbq.com.vn", provinceID = 10 });
                db.LOCATIONS.Add(new LOCATION() { locationID = 14, typeID = 2, locationName = "Tan Cang restaurant", locationAddress = "100A Ung Van Khiem Street, Ward 25, Binh Thanh District, Ho Chi Minh City", phoneNumber = "+84 8 3512 8775", website = "http://tancang-resort.com", provinceID = 10 });
                db.LOCATIONS.Add(new LOCATION() { locationID = 15, typeID = 2, locationName = "Monsoon", locationAddress = "1 Cao Ba Nha, Nguyen Cu Trinh Ward, District 1, Ho Chi Minh City", phoneNumber = "+84 8 6290 8899", website = "http://marry.vn", provinceID = 10 });
                db.LOCATIONS.Add(new LOCATION() { locationID = 16, typeID = 3, locationName = "Villa SaiGon River", locationAddress = "197/2 Nguyen Van Huong street, Thao Dien ward, District 2, Ho Chi Minh City", phoneNumber = "+84 8 3744 6090", website = "http://villasong.com", provinceID = 10 });
                db.LOCATIONS.Add(new LOCATION() { locationID = 17, typeID = 3, locationName = "The Reverie Sai Gon", locationAddress = "22-36 Nguyen Hue Boulevard, Ben Nghe Ward, District 1, Ho Chi Minh City", phoneNumber = "+84 8 3823 6688", website = "http://thereveriesaigon.com", provinceID = 10 });
                db.LOCATIONS.Add(new LOCATION() { locationID = 18, typeID = 3, locationName = "Intercontinental Asiana Sai Gon", locationAddress = "Hai Ba Trung Street, Ben Nghe Ward, District 1, Ho Chi Minh City", phoneNumber = "+84 8 3520 9999", website = "http://ihg.com", provinceID = 10 });
                db.LOCATIONS.Add(new LOCATION() { locationID = 19, typeID = 3, locationName = "Park Hyatt Sai Gon", locationAddress = "2 Cong Truong Lam Son, Ben Nghe Ward, District 1, Ho Chi Minh City", phoneNumber = "+84 8 3824 1234", website = "http://saigon.park.hyatt.com", provinceID = 10 });
                db.LOCATIONS.Add(new LOCATION() { locationID = 20, typeID = 3, locationName = "Rex Hotel", locationAddress = "141 Nguyen Hue Street, Ben Nghe Ward, District 1, Ho Chi Minh City", phoneNumber = "08 3829 2185", website = "http://rexhotelvietnam.com", provinceID = 10 });
                db.SaveChanges();
